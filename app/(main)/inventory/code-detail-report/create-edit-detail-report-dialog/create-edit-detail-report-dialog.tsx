...
export interface CreateEditEditReportDialogProps {
    data: any;
    handleClose: any;
}

export const CreateEditEditReportDialog: React.FC<CreateEditEditReportDialogProps> = ({
    data,
    handleClose,
}) => {
        ...
        <div>
            <div className="w-full flex mb-3 justify-content-between">
                <div className="flex align-items-center">
                    ...
                    <div className="font-bold text-2xl">{title + ' codigo reporte detalle'}</div>
                </div>
            </div>
...
export default CreateEditEditReportDialog;
